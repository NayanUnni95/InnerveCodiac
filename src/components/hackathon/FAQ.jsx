...
const faqs = [
  ...
  },
  {
    ...
    answer: "Food and Beverages would not be provided.But, internet Connectivity would be provided.",
  },
  {
    question: "What are the additional benefits provided?",
    answer: "Registration ID CARDs, Notepad and Pen, Stickers,certificate of Participation etc would be provided.",
  },
  {
  ...
  {
    question:
      "What is the format of hackathon?",
    answer:
