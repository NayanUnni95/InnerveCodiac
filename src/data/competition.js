export const competition = [
  ...
  },
  {
    ...
    price: '40',
    pricePool: '1000',
    guidelines:'.Can you desired programming language<br/> .Conducted in Hackerrank. Participants are advised to create an account if not having.<br/> . Your solution must follow a logical approach, not just print expected results.',
    note: 'noting to say!',
    contact: [
  ...
  },
  {
    ...
    pricePool: '1000',
    note: 'noting to say!',
    guidelines:'.can code in C or Python <br/> .if anyone uses an online compiler other than the platform provided,they will be disqualified',
    contact: [
  ...
  },
  {
    ...
    price: '40',
    pricePool: '1000',
    guidelines:'.Two levels of 45  and 30 mins.<br/> . Conducted in C language <br/> .Errors need to be corrected in the allowed duration',
    note: 'noting to say!',
    contact: [
